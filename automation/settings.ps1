...
$MODPACK_NAME = "clarkes-third-law"
...
$CLIENT_FILE_DISPLAY_NAME = "Clarkes Third Law $MODPACK_VERSION"
...
$SERVER_FILE_DISPLAY_NAME = "Clarkes Third Law Server $MODPACK_VERSION"
